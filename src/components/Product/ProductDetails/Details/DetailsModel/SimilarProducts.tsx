        ...
        <div className='custom-container1 flex flex-col gap-6'>
            {
                similar.map((item, index) => (
                    <div key={index} className='flex items-center justify-between relative gap-5'>
                        <Image src={item} alt='product' width={100} height={100} className='w-1/4 object-contain h-[20vh]' />
                        <div className='w-3/4 text-custom-black border rounded border-custom-black p-4 flex flex-col gap-6 relative'>
                            ...
                            <div className='w-full grid grid-cols-5 items-center gap-5'>
                                <div className='flex col-span-2 items-center justify-center gap-3 px-2 py-4 rounded border border-custom-black'>
