        ...
        <div className='flex flex-row items-start w-full justify-between'>
            <div className='flex flex-col gap-5'>
                ...
                <div className="flex flex-col gap-1">
                    <h2 className='font-bold text-xl text-custom-black '>Order Number</h2>
                    <p className='text-custom-blue'>#H452B3</p>
                </div>
                <div className="flex flex-col gap-1">
                    <h2 className='font-bold text-xl text-custom-black '>Order Address</h2>
                    <p className='text-custom-blue w-1/2 font-bold'>12 Mohamed Nagimb Street </p>
                </div>
                <div className="flex flex-col gap-1">
                    <h2 className='font-bold text-xl text-custom-black '>Paid by</h2>
                    <Image src={'/orders/visa.svg'} alt='visa' width={60} height={60} />
                </div>
            </div>
            <div className='rounded-xl p-4 flex flex-col gap-3 w-1/3 bg-white text-custom-black'>
