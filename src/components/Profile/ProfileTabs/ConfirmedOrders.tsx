...
const ConfirmedOrders = () => {
    return (
        <div
            className='col-span-2 p-5 border border-[#A4A4A4] rounded flex flex-col gap-5 h-full lg:h-[885px]'
                    ...
                    [1, 2, 3, 4, 5, 6].map((index) => (
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-2'>
                                <h4 className='text-xl lg:text-base'>Side Folding Mirror Motor W5</h4>
