...
const FirstLine = () => {
    return (
        <div className='grid grid-cols-6 items-start gap-1 w-full'>
            <div className='col-span-2 text-custom-black flex flex-col gap-4 w-full'>
            ...
            <div className='col-span-4 bg-[#F4F3F3] border border-[#9D9D9D] p-5 rounded flex flex-col gap-5'>
                ...
                <p className='text-sm text-[#525252] w-3/4'>
