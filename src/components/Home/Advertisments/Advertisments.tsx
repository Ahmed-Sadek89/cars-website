    ...
    return (
        <section className='custom-container1 py-10'>
            <div className="grid grid-cols-4 items-center gap-5">
                ...
                <div className={`col-span-2 bg-[url('/home/advertisment/adv3.jpg')] bg-cover bg-center bg-no-repeat h-[428.3px]`}>
                    <div className='bg-[#00000066] h-full flex flex-col gap-4 items-center justify-center text-white'>
                        <h3 className='leading-[1.2] text-5xl w-2/3 text-center'>The best lighting available Now</h3>
