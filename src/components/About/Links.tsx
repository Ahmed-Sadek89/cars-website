    ...
    return (
        <div className='custom-container2 py-10'>
            <div className="grid grid-cols-2 items-start gap-10">
                <div
                    className='rounded border border-[#D4DEE7] p-10 flex flex-row items-center gap-10 relative'
                ...
                <div className='rounded border border-[#F0F0F0] bg-[#F0F0F0] p-10 flex flex-row items-center gap-10 relative' >
