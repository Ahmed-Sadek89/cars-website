    ...
    return (
        <div className='custom-container1 flex flex-col gap-10 pb-20'>
            <div className='flex flex-row items-center gap-20'>
                <h2 className='font-bold text-lg'>{car_year} {car_model} {car_series} Accessories & Parts</h2>
                <Link href={"#"} className='bg-white border border-custom-blue py-2 px-5 text-custom-blue font-bold rounded'>Shop By Size</Link>
            </div>
            <div className='relative w-full h-[60vh] '>
                <Image src={'/search/item.png'} alt={`${car_year} ${car_model} ${car_series}`} fill className='object-cover' />
            </div>
