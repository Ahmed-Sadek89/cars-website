    ...
    return (
        <section className='custom-container2'>
            <div className=' bg-custom-blue rounded-md shadow-xl pb-6 pt-9 px-8 flex flex-col gap-3'>
                ...
                <div className='bg-transparent lg:bg-white grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-3 gap-x-0 lg:gap-x-3 items-center rounded-full p-4'>
                    <SelectInput data={carModels} value={carModelValue} setValue={setCarModelValue} />
                    <div className='col-span-2 grid grid-cols-2 items-center gap-4 lg:gap-0'>
